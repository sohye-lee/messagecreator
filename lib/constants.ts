...
export const metadata = {
  title: "Blinkless AI Message Generator",
  description:
...
export const purposes: string[] = [
  "Greetings (e.g., Hello, Happy Birthday)",
  "Thank Yous (e.g., Gratitude, Appreciation)",
  "Congratulations (e.g., Achievements, Milestones)",
  "Apologies (e.g., Sorry, Regret)",
  "Invitations (e.g., Events, Meetings)",
  "Announcements (e.g., News, Updates)",
  "Reminders (e.g., Appointments, Deadlines)",
  "Expressing Feelings (e.g., Love, Sympathy)",
];
